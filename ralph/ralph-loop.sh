...
5. Run pnpm run typecheck and npx jest to confirm all checks pass. \
6. Make small commits following conventional commits. As you go, tick off acceptance criteria and plan steps in the GitHub issue. \
7. Push the branch, open a PR, and move the issue to 'In Review' on the board. \
