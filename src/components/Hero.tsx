    ...
    >
      <div className="flex gap-2 bg-[var(--color-surface)] border border-[var(--color-border-strong)] rounded-[var(--radius-input)] p-2 max-w-[420px] mx-auto focus-within:border-[var(--color-brand)]" role="group" aria-label="Enter postcode">
        ...
        <Primitive.input
          ...
          spellCheck={false}
        />
        <Primitive.button type="submit" className="flex-shrink-0 bg-[#3aad63] text-white rounded-[var(--radius-button)] text-sm font-semibold px-4 py-2 hover:bg-[#52c278] flex items-center gap-1 whitespace-nowrap cursor-pointer" aria-label="Get electricity data for this postcode">
          {ARROW_ICON}
          Look up
        </Primitive.button>
      </div>
